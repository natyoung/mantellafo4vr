...
class AIClient(ABC):
    ...
    @abstractmethod
    def streaming_call(self, messages: Message | message_thread, is_multi_npc: bool, tools: list[dict] = None, model_override: str | None = None) -> AsyncGenerator[str | None, None]:
