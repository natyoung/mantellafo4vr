...
class MantellaConfigValueDefinitionsClassic:
    ...
    def get_config_values(on_value_change_callback: Callable[..., Any] | None = None) -> list[ConfigValue]:
        ...
        prompt_category.add_config_value(PromptDefinitions.get_stt_prompt_fallout4_config_value())
        prompt_category.add_config_value(PromptDefinitions.get_stt_prompt_skyrim_config_value())
