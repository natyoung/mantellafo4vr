...
class ConfigLoader:
    ...
    def __update_config_values_from_current_state(self):
        ...
        try:
            ...
            self.interruption_delay = self.__definitions.get_float_value("interruption_delay")
...
LLM parameter list must follow the Python dictionary format: https://www.w3schools.com/python/python_dictionaries.asp""")
            ...
            self.quest_trigger_phrase = self.__definitions.get_string_value("quest_trigger_phrase")
            ...
            self.rumor_prompt = self.__definitions.get_string_value("rumor_prompt")
