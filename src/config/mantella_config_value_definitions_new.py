...
class MantellaConfigValueDefinitionsNew:
    ...
    def get_config_values(is_integrated: bool, on_value_change_callback: Callable[..., Any] | None = None) -> ConfigValues:
        ...
        stt_category.add_config_value(STTDefinitions.get_interruption_delay_config_value())
        ...
        prompts_category.add_config_value(PromptDefinitions.get_diary_prompt_config_value())
        prompts_category.add_config_value(PromptDefinitions.get_diary_interval_days_config_value())
        prompts_category.add_config_value(PromptDefinitions.get_diary_min_summaries_config_value())
        ...
        other_category.add_config_value(OtherDefinitions.get_summary_recall_model_config_value())
